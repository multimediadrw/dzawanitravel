export default function BisnisTravel() {
  return (
      ...
      <section className="relative bg-gradient-to-br from-purple to-magenta text-white py-24">
        <div className="container-main mx-auto px-4 md:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-6">
            Kenapa Harus Berbisnis Travel Umroh & Haji?
          </h1>
          <p className="text-xl md:text-2xl font-light max-w-4xl mx-auto">
            UMROH adalah Bisnis TERDAHSYAT Sepanjang ZAMAN – Stabil, Syariah, dan Selalu Dicari!
          </p>
        </div>
      </section>
        ...
        <div className="container-main mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all">
              <div className="w-16 h-16 bg-gradient-to-br from-purple to-magenta rounded-full flex items-center justify-center mb-6 mx-auto">
              ...
              <h3 className="text-2xl font-bold text-purple mb-4 text-center">Tren Sepanjang Masa</h3>
              <p className="text-gray-600 text-center leading-relaxed">
                Umroh tidak tergantung musim & tren. Permintaan selalu stabil sepanjang tahun.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all">
              ...
              <h3 className="text-2xl font-bold text-purple mb-4 text-center">Destinasi Tidak Berubah</h3>
              <p className="text-gray-600 text-center leading-relaxed">
                Selalu ke Mekkah dan Madinah. Tidak tergantung minat wisata yang berubah-ubah.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all">
              ...
              <h3 className="text-2xl font-bold text-purple mb-4 text-center">Demand Selalu Ada</h3>
              <p className="text-gray-600 text-center leading-relaxed">
                Dari tahun ke tahun, jumlah jamaah terus meningkat. Pasar tidak pernah sepi.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-purple to-magenta">
        <div className="container-main mx-auto px-4 md:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Bergabunglah dengan Dzawani Travel dan raih kesuksesan bersama kami!
          </p>
          <a
