export default function TestimoniMitra() {
  const testimonials = [
    {
      name: 'Nur Aini',
      location: 'Bandung',
      quote: 'Baru sebulan gabung, sudah closing 4 jamaah. Modal balik, dapat komisi, dan dapat komunitas supportif!',
      avatar: '👩‍💼',
    },
    {
      name: 'Ahmad Fauzi',
      location: 'Jakarta',
      quote: 'Alhamdulillah, dari yang tadinya ragu, sekarang sudah berangkatkan 10 jamaah. Komisi mengalir terus!',
      avatar: '👨‍💼',
    },
    {
      name: 'Siti Maryam',
      location: 'Surabaya',
      quote: 'Sistem online-nya mudah, tools lengkap, dan tim support selalu siap bantu. Recommended banget!',
      avatar: '👩',
    },
    {
      name: 'Budi Santoso',
      location: 'Yogyakarta',
      quote: 'Bisnis travel umroh ini benar-benar menguntungkan. Saya sudah dapat umroh gratis di jamaah ke-5!',
      avatar: '👨',
    },
  ];
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-purple">{testimonial.name}</h3>
